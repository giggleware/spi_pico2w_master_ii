...
static inline uint32_t spi_readwrite(uint8_t out_buf[], uint8_t in_buf[])
{
    ...
    uint16_t first_two_byte_value = ((uint16_t)in_buf[0] << 8) | ((uint16_t)in_buf[1]);
    uint32_t three_byte_value = pack24(in_buf[0], in_buf[1], in_buf[2]);
